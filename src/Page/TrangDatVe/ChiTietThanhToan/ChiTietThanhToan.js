            ...
            <div id={chiTietThanhToanMobile}  className="booking_payment">
                ...
                <form className="method_payment text-left">
                    ...
                    <div className="method_detail my-2">
                        <input type="radio" name="payment" value="visa" id="visa" className="inputChecked"></input>
                    ...
                    <div className="method_detail">
                        <input type="radio" name="payment" value="tienmat" id="tiemmat" className="inputChecked"></input>
